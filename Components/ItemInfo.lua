...
-- Module-level reusables to avoid temporary string allocation on hot paths.
local _getTooltip_parts = {}          -- reused by GetTooltip() for table.concat
local _itemLink_fmt = "%s|H%s|H[%s]|H|r"        -- format string for itemLink construction
local _getUniqueItemId_fmt = "%s:%s:%s:%s:%s"    -- format string for GetUniqueItemId()
